...
import { Save, TestTube, Plus, Trash2, ExternalLink } from "lucide-react";
...
export default function Settings() {
  ...
  const [newRule, setNewRule] = useState({ name: "", pattern: "", score_modifier: 0, enabled: true });
  ...
  const saveConfig = () => {
    // Only send fields that aren't masked
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewRule((r) => ({ ...r, score_modifier: parseInt(e.target.value) || 0 }))
                      }
                    />
                  </div>
                </div>
